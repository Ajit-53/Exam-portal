<?php
	...
	if(isset($_POST['submit'])){
		$query = "INSERT INTO answers values ('".$_SESSION['roll']."'";
		for($i = 1; $i <= $n; $i++){
		...
		<div class="container d-flex justify-content-center">
			<div class="col-sm-10 col-md-8 col-lg-6 bg-light shadow-lg" style="margin: 10px; border-radius: 5px;">
				<?php
					...
					$markingRes = mysqli_query($con, "SELECT * FROM admin");
					$marking = mysqli_fetch_array($markingRes);
					...
					$marks = ($countC * $marking['pmarks']) - ($countI * $marking['nmarks']);
